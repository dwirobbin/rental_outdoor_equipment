...
class BillingTable extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.app.backend.admin.billings.billing-table', [
            'billings' => $data,
        ]);
    }
    ...
    #[On('confirm-delete-selected-billing')]
    public function deleteSelected(): void
    {
        $this->dispatch('swal-confirm-delete-selected-billing', selectedIds: $this->bulkSelected);
    }
