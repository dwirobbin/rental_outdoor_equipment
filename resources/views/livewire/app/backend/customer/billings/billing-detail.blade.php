            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('customer_area.billing.index') }}">Tagihan</a></li>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="float-end mt-3">
                                <p><b>Hello, {{ $billing->order->orderedBy->name }}</b></p>
                                <p class="text-muted font-13">
                                    Di bawah ini adalah rincian biaya yang harus dibayar. Silakan lakukan pembayaran
                                    sesegera mungkin.
                                </p>
                            </div>
                        ...
                        <div class="col-sm-4 offset-sm-2">
                            <div class="mt-3 float-sm-end">
                                <p class="font-13"><strong>Tanggal Order: </strong> &nbsp;&nbsp;&nbsp; {{ $billing->order->start_date }}</p>
                                <p class="font-13"><strong>Status Order: </strong>
                    ...
                    <h4 class="header-title my-3 text-center">Silahkan Melakukan Pembayaran di salah satu nomor berikut!</h4>
                    ...
                    <div class="d-print-none">
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('customer_area.billing.index') }}" class="btn btn-info">Kembali</a>
