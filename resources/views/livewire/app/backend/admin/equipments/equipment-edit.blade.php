        ...
        <form enctype="multipart/form-data">
            ...
            <div class="mb-1">
                ...
                <div class="d-flex justify-content-center mb-1">
                    @if ($form->new_photo)
                        <img src="{{ $form->new_photo->temporaryUrl() }}" alt="foto-peralatan" class="rounded" height="75">
                    @else
                        <img src="{{ !is_null($form->photo) ? asset('storage/image/equipments/' . $form->photo) : asset('src/backend/images/no_image.png') }}"
