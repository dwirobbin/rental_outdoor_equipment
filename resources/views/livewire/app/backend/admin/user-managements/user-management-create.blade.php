        ...
        <form enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex justify-content-center mb-1">
                    @if ($form->photo)
                        <img src="{{ $form->photo->temporaryUrl() }}" alt="foto-profil" class="rounded" height="75">
                    @else
            ...
            <div class="mb-1">
                <label for="isActive" class="form-label">Status Akun</label>
                <div class="form-switch ps-0">
                    <label class="toggle">
                        <input type="checkbox" id="isActive" wire:model='form.is_active'>
