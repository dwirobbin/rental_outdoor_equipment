                ...
                mutationObserver = new MutationObserver(function (mutations) {
                    mutations.forEach(function (mutation) {
                        ...
                        mutation.removedNodes.forEach(function (removedNode) {
                            // Pastikan node yang dihapus adalah elemen dengan atribut "data-aos"
                            if (
                                removedNode.nodeType === 1 &&
                                removedNode.hasAttribute &&
                                removedNode.hasAttribute("data-aos")
                            ) {
                                // Panggil fungsi yang diinginkan (dalam hal ini, fungsi dari modul f.default)
                                (0, f.default)(S, 50, !0);
                            }
                        });
                    });
                        ...
                        E(j.disable) || x
                            ...
                            : (document
                              ...
                              mutationObserver.observe(document.body, {
                                  childList: true, // Menanggapi perubahan pada child nodes (termasuk penambahan dan penghapusan)
                                  subtree: true, // Menanggapi perubahan pada subtree (termasuk nested elements)
                                  attributes: false, // Tidak perlu menanggapi perubahan atribut
                                  characterData: false, // Tidak perlu menanggapi perubahan data karakter
                              }),
                              // Jangan lupa untuk memberhentikan pengamat ketika tidak diperlukan lagi
